...
export class Migration20250513133309 extends Migration {
  override async up(): Promise<void> {
    ...
    this.addSql(
      `alter table "exerc_set" add column "name" varchar(255) not null;`,
    );

    this.addSql(
      `alter table "training" rename column "exerc_set_id" to "exerc_set_id_id";`,
    );
    this.addSql(
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(
      `alter table "exercise" add column "exerc_set_id" int not null;`,
    );
    this.addSql(
    ...
    this.addSql(
      `alter table "training" rename column "exerc_set_id_id" to "exerc_set_id";`,
    );
    this.addSql(
